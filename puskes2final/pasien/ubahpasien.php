...
if (isset($_POST['submit'])) {
    ...
    $queryUbah = "UPDATE Pasien SET Nama_P = '$namaBaru', Alamat = '$alamatBaru', Domisili = '$domisiliBaru', Tgl_lahir = '$tglLahirBaru', No_HP = '$noHPBaru', Jenis_Kelamin = '$jenisKelaminBaru' WHERE ID_Pasien = $idPasien";
        ...
        <form action="" method="post">
            ...
            <div class="form-column-pasien">
                <div class="form-group-pasien">
                    ...
                    <input type="date" name="tgl_lahir" value="<?php echo isset($tglLahir) ? $tglLahir : ''; ?>"
                        required>
                </div>
                <div class="form-group-pasien">
                    <label for="jenis_kelamin">Jenis Kelamin</label>
                    <select name="jenis_kelamin" required>
                        <option value="L" <?php if ($jenisKelamin == 'L')
                            echo 'selected'; ?>>Laki-laki</option>
                        <option value="P" <?php if ($jenisKelamin == 'P')
